...
public:
    ...
    //Bitwise operations && primitive math.
    ...
    /**
     *
     * @point - Get child process id of second process by name.
     *
     * @args  - Process: Target process name.
     *
     */

    static int GetChildProcessID (std::string process);
